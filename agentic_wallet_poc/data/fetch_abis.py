"""
Bootstrap script: fetch verified ABIs from Etherscan for all protocol contracts.

- Detects proxy contracts and fetches the implementation ABI automatically
- Caches ABIs as JSON files in data/abi_cache/
- Only needs to run once (or when adding new protocols)

Usage:
  python data/fetch_abis.py
